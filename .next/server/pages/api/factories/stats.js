"use strict";(()=>{var e={};e.id=11,e.ids=[11],e.modules={9424:e=>{e.exports=require("mssql")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,r){return r in t?t[r]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,r)):"function"==typeof t&&"default"===r?t:void 0}}})},2633:(e,t,r)=>{r.r(t),r.d(t,{config:()=>l,default:()=>u,routeModule:()=>f});var n={};r.r(n),r.d(n,{default:()=>c});var a=r(1802),o=r(7153),s=r(6249),i=r(9077);async function c(e,t){if("GET"!==e.method)return t.setHeader("Allow",["GET"]),t.status(405).json({error:`不支援 ${e.method} 方法`});try{let e=await (0,i.EE)();return t.status(200).json(e)}catch(e){return console.error("API Error:",e),t.status(500).json({error:"獲取統計資料失敗",message:"請稍後再試"})}}let u=(0,s.l)(n,"default"),l=(0,s.l)(n,"config"),f=new a.PagesAPIRouteModule({definition:{kind:o.x.PAGES_API,page:"/api/factories/stats",pathname:"/api/factories/stats",bundlePath:"",filename:""},userland:n})},7153:(e,t)=>{var r;Object.defineProperty(t,"x",{enumerable:!0,get:function(){return r}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(r||(r={}))},1802:(e,t,r)=>{e.exports=r(145)},9077:(e,t,r)=>{r.d(t,{ZP:()=>u,lT:()=>i,fw:()=>o,EE:()=>c,C$:()=>s});var n=r(9424);require("dotenv").config({path:".env.local"});let a={server:process.env.DB_SERVER||"cfmclouddb.c3sw88geq0el.ap-southeast-2.rds.amazonaws.com",database:process.env.DB_DATABASE||"CFMdatabase",user:process.env.DB_USER||"Edison",password:process.env.DB_PASSWORD||"Edison0528",port:parseInt(process.env.DB_PORT||"1433"),options:{encrypt:!0,trustServerCertificate:!0,enableArithAbort:!0}};async function o(e){let t;try{return t=await new n.ConnectionPool(a).connect(),(await t.request().input("id",n.Int,e).query(`
      ...
      FROM factories;
    `)).recordset[0]}catch(e){throw console.error("Database Error:",e),Error("獲取統計資料失敗")}finally{e&&await e.close()}}let u=a}};var t=require("../../../webpack-api-runtime.js");t.C(e);var r=t(t.s=2633);module.exports=r})();